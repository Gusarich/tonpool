...
echo -e "${COLOR}[2/5]${ENDC} Cloning github repository"
cd $SOURCES_DIR
...
echo -e "${COLOR}[3/5]${ENDC} Preparing for compilation"
rm -rf $BIN_DIR/ton
mkdir $BIN_DIR/ton
cd $BIN_DIR/ton
...
echo -e "${COLOR}[4/5]${ENDC} Source Compilation"
...
make -j ${cpuNumber} pow-miner

cp $BIN_DIR/ton/crypto/pow-miner $BIN_DIR/pow-miner
